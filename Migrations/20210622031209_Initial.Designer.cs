...
namespace MathModeling21.Migrations
{
    ...
    [Migration("20210622031209_Initial")]
...
You’ll find interesting articles to read on topics like how to stop procrastinating as well as personal recommendations like my list of the best books to read and my minimalist travel guide.Ready to dive in? You can use the categories below to browse my best articles.",
                            ...
                            PostDate = new DateTime(2021, 6, 22, 10, 12, 9, 246, DateTimeKind.Local).AddTicks(9151),
            ...
            modelBuilder.Entity("MathModeling21.Models.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PostDate = new DateTime(2021, 6, 22, 10, 12, 9, 249, DateTimeKind.Local).AddTicks(6407)
                        });
                });
